    ...
    <div className={styles.how}>
        <div className={styles.howInner}>
            <div className={styles.imgBox}>
                <Image style={{objectFit: 'cover'}} fill src={ILLU1} alt="illustration" />
            </div>
            <div className={styles.right}>
                <h2 className={styles.heading}>How It Works</h2>
                <div ref={refOne} className={`${styles.step} ${oneInView && styles.selected}`}>
                ...
                <div ref={refTwo} className={`${styles.step} ${twoInView && styles.selected}`}>
                    <h5 className={styles.headingTwo}>2. Compare Price</h5>
                    <p className={styles.p}>Request quotes from our 102.222 rated transport providers</p>
                </div>
                <div ref={refThree} className={`${styles.step} ${threeInView && styles.selected}`}>
