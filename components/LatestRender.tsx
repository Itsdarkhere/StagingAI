...
export default function LatestRender({image}: {image: StaticImageData}) {
  return (
    <div className={styles.latestRender}>
        ...
        style={{width: '100%', height: 'auto', maxHeight: 400, objectFit: 'cover', borderRadius: 4}} 
        src={image} alt="render" />
        <p className={styles.p}>Created in 9 seconds</p>
        <h6 className={styles.heading}>Interior Design of a Midcentury Modern Bedroom</h6>
    </div>
  )
}
